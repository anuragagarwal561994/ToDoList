...
var showAllLocations = function(){
	...
	for(var marker in markers)
		$("#location-list ul").append("<li><a href='#set-location' data-role='button'>"+marker.placeName+"</a></li>");
	// for(int i=0;i<markers.length;i++)	
	// 	$("#location-list ul").append("<li><a data-role='button'>"+markers[i].placeName+"</li>");
}